!(function (t) {
    ...
    r("replace", 2, function (t, e, n, r) {
      ...
      return [
        ...
        function (t, r) {
          ...
          for (var b, S = "", T = 0, O = 0; O < w.length; O++) {
            _ = w[O];
            for (
              var P = String(_[0]),
                I = l(d(c(_.index), g.length), 0),
                k = [],
                C = 1;
              C < _.length;
              C++
            ...
            var j = _.groups;
            if (x) {
              var D = [P].concat(k, I, g);
              void 0 !== j && D.push(j);
              var R = String(r.apply(void 0, D));
            } else R = f(P, g, I, k, j, r);
            I >= T && ((S += g.slice(T, I) + R), (T = I + P.length));
          }
          return S + g.slice(T);
        },
      ];
  ...
  ,
  function (t, e, n) {
    n(156), (t.exports = n(244));
  },
  function (t, e, n) {
    "use strict";
    n.r(e);
    n(45), n(62), n(42), n(35), n(98), n(28);
    !(function () {
      var t = Date.now();
      var e =
      ...
      function i(t) {
        !(function (t, e) {
          ...
          ""
            .concat(r.replace(/\/$/, ""), "/")
            .concat("1_174_0", "/static/js/widget.")
            .concat(n.h, ".js")
        );
      }
      var c = n(245).default;
      (window.tidioChatApi = new c()),
        o(function () {
          return setTimeout(function () {
            var o = window.document.getElementById("tidio-chat-code"),
              c = window.Shopify && !0 === window.Shopify.designMode,
            ...
            !(function (t, e, n) {
              ...
              e &&
                ...
                (function (t) {
                  var e = "//localhost:3000/static/js/WidgetIframe.js";
                  e = ""
                    .concat(r)
                    .concat("1_174_0", "/static/js/chunk-WidgetIframe-")
                    .concat(n.h, ".js");
                ...
                (function (t) {
                  ...
                  (e.rel = "preload"),
                    (e.href = "".concat(
                      "https://widget-v4.tidiochat.com/",
                      "fonts/mulish_SGhgqk3wotYKNnBQ.woff2"
                    )),
                    (e.as = "font"),
                    (e.type = "font/woff2"),
                    (e.crossOrigin = ""),
                ...
                (o.contentWindow.FIRST_POSSIBLE_JS_EXECUTION = t),
